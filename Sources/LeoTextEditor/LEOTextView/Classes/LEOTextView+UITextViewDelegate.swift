...
extension LEOTextView: UITextViewDelegate {
    ...
    public func textView(_ textView: UITextView, shouldInteractWith textAttachment: NSTextAttachment, in characterRange: NSRange, interaction: UITextItemInteraction) -> Bool {
        if nck_delegate != nil && nck_delegate!.responds(to: #selector(self.textView(_:shouldInteractWith:in:interaction:) as (UITextView, NSTextAttachment, NSRange, UITextItemInteraction) -> Bool) as Selector?) {
            return nck_delegate!.textView!(textView, shouldInteractWith: textAttachment, in: characterRange, interaction: interaction)
        }
        return true
    }

    public func textView(_ textView: UITextView, shouldInteractWith URL: URL, in characterRange: NSRange, interaction: UITextItemInteraction) -> Bool {
        if nck_delegate != nil && nck_delegate!.responds(to: #selector(self.textView(_:shouldInteractWith:in:interaction:) as (UITextView, URL, NSRange, UITextItemInteraction) -> Bool) as Selector?) {
            return nck_delegate!.textView!(textView, shouldInteractWith: URL, in: characterRange, interaction: interaction)
        }
        return true
    }
